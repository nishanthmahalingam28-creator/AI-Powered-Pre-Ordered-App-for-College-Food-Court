...
function build(){
 ...
 aside.innerHTML=
  ...
  '</nav>'+
  '<div class="customer-workspace-user"><div class="customer-workspace-avatar" id="sidebar-avatar">'+initial+'</div><div class="min-w-0"><strong id="sidebar-user-name">'+name+'</strong><span id="sidebar-user-type">'+role+'</span></div><button class="customer-workspace-logout" onclick="if(typeof handleCustomerLogout==='function'){handleCustomerLogout();}" title="Logout"><i class="fa-solid fa-arrow-right-from-bracket"></i></button></div>';
